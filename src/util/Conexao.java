...
public class Conexao {
    ...
    {   erro="";
        connect=null;
        conectar("jdbc:postgresql://localhost/", "librarymanagement", "postgres", "postgres123");
    }
    ...
    {   boolean conectado=false;
        try {
            ...
            connect = DriverManager.getConnection( "jdbc:postgresql://localhost/librarymanagement", "postgres","postgres123");
            conectado=true;
        }
